...
export function getFirstLast(array) {
  ...
  //firstLastArray.push(first)
  //firstLastArray.push(last)
  //2nd version
  //getFirstLastArray.push(array[0])
  //getFirstLastArray.push(array[array.length -1])
